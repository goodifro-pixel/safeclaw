...
class CommandParser:
    ...
    def _setup_default_intents(self) -> None:
        ...
        default_intents = [
            ...
            IntentPattern(
                intent="ai_coder",
                keywords=["ai-code", "ai code", "generate code", "write code",
                          "create code", "build app"],
                patterns=[
                    r"ai[\s-]code\s*(.*)",
                    r"(?:generate|write|create)\s+code\s*(.*)",
                    r"build\s+(?:me\s+)?(?:an?\s+)?app\s*(.*)",
                ],
                examples=[
                    "ai-code generate a REST API",
                    "ai-code plan a todo app",
            ...
            IntentPattern(
                intent="bug_finder",
                keywords=["bug-find", "bugfind", "find bugs", "scan bugs",
                          "static analysis", "security scan", "check code"],
                patterns=[
                    r"bug[\s-]?find\s*(.*)",
                    r"find\s+bugs?\s*(.*)",
                    r"scan\s+(?:for\s+)?bugs?\s*(.*)",
                    r"(?:static|security)\s+(?:analysis|scan)\s*(.*)",
                    r"check\s+code\s*(.*)",
                ],
                examples=[
                    "bug-find ./src",
                    "find bugs in main.py",
            ...
            IntentPattern(
                intent="deployer",
                keywords=["deploy", "deploy github", "deploy pages", "deploy fly",
                          "push code", "ship code"],
                patterns=[
                    r"deploy\s*(.*)",
                    r"(?:push|ship|publish)\s+code\s*(.*)",
                ],
                examples=[
                    "deploy github ./myapp --repo user/repo",
                    "deploy pages ./site",
                    "deploy ci ./project",
                ],
                slots=["target", "path"],
            ...
            IntentPattern(
                intent="ai_dev",
                keywords=["ai-dev", "ai dev", "ai pipeline", "full pipeline",
                          "build and deploy", "autonomous dev"],
                patterns=[
                    r"ai[\s-]dev\s*(.*)",
                    r"(?:full\s+)?pipeline\s*(.*)",
                    r"build\s+and\s+deploy\s*(.*)",
                    r"autonomous\s+dev\s*(.*)",
                ],
                examples=[
                    "ai-dev a REST API with authentication",
                    "ai dev a todo app --repo user/repo",
                    "build and deploy a calculator",
                ],
                slots=["description"],
            ),
        ]
